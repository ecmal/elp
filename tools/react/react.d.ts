...
type NativeAnimationEvent = any;
type NativeClipboardEvent = any;
type NativeCompositionEvent = any;
type NativeDragEvent = any;
type NativeFocusEvent = any;
type NativeKeyboardEvent = any;
type NativeMouseEvent = any;
type NativeTouchEvent = any;
type NativeTransitionEvent = any;
type NativeUIEvent = any;
type NativeWheelEvent = any;
...
declare namespace React {
    ...
    interface DOMElement<P extends HTMLAttributes<T> | SVGAttributes<T>, T extends object> extends ReactElement<P> {
        type: string;
        ref: Ref<T>;
    }
    ...
    interface ReactHTMLElement<T extends object> extends DetailedReactHTMLElement<AllHTMLAttributes<T>, T> { }

    interface DetailedReactHTMLElement<P extends HTMLAttributes<T>, T extends object> extends DOMElement<P, T> {
        type: keyof ReactHTML;
    }

    // ReactSVG for ReactSVGElement
    interface ReactSVGElement extends DOMElement<SVGAttributes<object>, object> {
        type: keyof ReactSVG;
    }
    ...
    type DOMFactory<P extends DOMAttributes<T>, T extends object> =
        (props?: ClassAttributes<T> & P | null, ...children: ReactNode[]) => DOMElement<P, T>;

    // tslint:disable-next-line:no-empty-interface
    interface HTMLFactory<T extends object> extends DetailedHTMLFactory<AllHTMLAttributes<T>, T> {}

    interface DetailedHTMLFactory<P extends HTMLAttributes<T>, T extends object> extends DOMFactory<P, T> {
        (props?: ClassAttributes<T> & P | null, ...children: ReactNode[]): DetailedReactHTMLElement<P, T>;
    }

    interface SVGFactory extends DOMFactory<SVGAttributes<object>, object> {
        (props?: ClassAttributes<object> & SVGAttributes<object> | null, ...children: ReactNode[]): ReactSVGElement;
    }
    ...
    // DOM Elements
    function createFactory<T extends object>(
        type: keyof ReactHTML): HTMLFactory<T>;
    function createFactory(
        type: keyof ReactSVG): SVGFactory;
    function createFactory<P extends DOMAttributes<T>, T extends object>(
    ...
    // DOM Elements
    function createElement<P extends HTMLAttributes<T>, T extends object>(
        type: keyof ReactHTML,
        props?: ClassAttributes<T> & P,
        ...children: ReactNode[]): DetailedReactHTMLElement<P, T>;
    function createElement<P extends SVGAttributes<T>, T extends object>(
        type: keyof ReactSVG,
        props?: ClassAttributes<T> & P,
        ...children: ReactNode[]): ReactSVGElement;
    function createElement<P extends DOMAttributes<T>, T extends object>(
        type: string,
        props?: ClassAttributes<T> & P,
    ...
    // DOM Elements
    // ReactHTMLElement
    function cloneElement<P extends HTMLAttributes<T>, T extends object>(
    ...
    // object
    function cloneElement<P extends SVGAttributes<T>, T extends object>(
        element: ReactSVGElement,
        props?: P,
        ...children: ReactNode[]): ReactSVGElement;
    // DOM object (has to be the last, because type checking stops at first overload that fits)
    function cloneElement<P extends DOMAttributes<T>, T extends object>(
    ...
    type ReactInstance = Component<any> | object;
    ...
    interface SyntheticEvent<T> {
        ...
        persist(): void;
        // If you thought this should be `object & T`, see https://github.com/DefinitelyTyped/DefinitelyTyped/pull/12239
        target: object;
        timeStamp: number;
        type: string;
    }
    ...
    interface DOMAttributes<T> {
        ...
        onError?: ReactEventHandler<T>; // also a Media object
        onErrorCapture?: ReactEventHandler<T>; // also a Media object
    ...
    interface ReactHTML {
        a: DetailedHTMLFactory<AnchorHTMLAttributes<object>, object>;
        abbr: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        address: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        area: DetailedHTMLFactory<AreaHTMLAttributes<object>, object>;
        article: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        aside: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        audio: DetailedHTMLFactory<AudioHTMLAttributes<object>, object>;
        b: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        base: DetailedHTMLFactory<BaseHTMLAttributes<object>, object>;
        bdi: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        bdo: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        big: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        blockquote: DetailedHTMLFactory<BlockquoteHTMLAttributes<object>, object>;
        body: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        br: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        button: DetailedHTMLFactory<ButtonHTMLAttributes<object>, object>;
        canvas: DetailedHTMLFactory<CanvasHTMLAttributes<object>, object>;
        caption: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        cite: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        code: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        col: DetailedHTMLFactory<ColHTMLAttributes<object>, object>;
        colgroup: DetailedHTMLFactory<ColgroupHTMLAttributes<object>, object>;
        data: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        datalist: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        dd: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        del: DetailedHTMLFactory<DelHTMLAttributes<object>, object>;
        details: DetailedHTMLFactory<DetailsHTMLAttributes<object>, object>;
        dfn: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        dialog: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        div: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        dl: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        dt: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        em: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        embed: DetailedHTMLFactory<EmbedHTMLAttributes<object>, object>;
        fieldset: DetailedHTMLFactory<FieldsetHTMLAttributes<object>, object>;
        figcaption: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        figure: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        footer: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        form: DetailedHTMLFactory<FormHTMLAttributes<object>, object>;
        h1: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        h2: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        h3: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        h4: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        h5: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        h6: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        head: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        header: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        hgroup: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        hr: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        html: DetailedHTMLFactory<HtmlHTMLAttributes<object>, object>;
        i: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        iframe: DetailedHTMLFactory<IframeHTMLAttributes<object>, object>;
        img: DetailedHTMLFactory<ImgHTMLAttributes<object>, object>;
        input: DetailedHTMLFactory<InputHTMLAttributes<object>, object>;
        ins: DetailedHTMLFactory<InsHTMLAttributes<object>, object>;
        kbd: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        keygen: DetailedHTMLFactory<KeygenHTMLAttributes<object>, object>;
        label: DetailedHTMLFactory<LabelHTMLAttributes<object>, object>;
        legend: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        li: DetailedHTMLFactory<LiHTMLAttributes<object>, object>;
        link: DetailedHTMLFactory<LinkHTMLAttributes<object>, object>;
        main: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        map: DetailedHTMLFactory<MapHTMLAttributes<object>, object>;
        mark: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        menu: DetailedHTMLFactory<MenuHTMLAttributes<object>, object>;
        menuitem: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        meta: DetailedHTMLFactory<MetaHTMLAttributes<object>, object>;
        meter: DetailedHTMLFactory<MeterHTMLAttributes<object>, object>;
        nav: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        noscript: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        object: DetailedHTMLFactory<ObjectHTMLAttributes<object>, object>;
        ol: DetailedHTMLFactory<OlHTMLAttributes<object>, object>;
        optgroup: DetailedHTMLFactory<OptgroupHTMLAttributes<object>, object>;
        option: DetailedHTMLFactory<OptionHTMLAttributes<object>, object>;
        output: DetailedHTMLFactory<OutputHTMLAttributes<object>, object>;
        p: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        param: DetailedHTMLFactory<ParamHTMLAttributes<object>, object>;
        picture: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        pre: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        progress: DetailedHTMLFactory<ProgressHTMLAttributes<object>, object>;
        q: DetailedHTMLFactory<QuoteHTMLAttributes<object>, object>;
        rp: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        rt: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        ruby: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        s: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        samp: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        script: DetailedHTMLFactory<ScriptHTMLAttributes<object>, object>;
        section: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        select: DetailedHTMLFactory<SelectHTMLAttributes<object>, object>;
        small: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        source: DetailedHTMLFactory<SourceHTMLAttributes<object>, object>;
        span: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        strong: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        style: DetailedHTMLFactory<StyleHTMLAttributes<object>, object>;
        sub: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        summary: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        sup: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        table: DetailedHTMLFactory<TableHTMLAttributes<object>, object>;
        tbody: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        td: DetailedHTMLFactory<TdHTMLAttributes<object>, object>;
        textarea: DetailedHTMLFactory<TextareaHTMLAttributes<object>, object>;
        tfoot: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        th: DetailedHTMLFactory<ThHTMLAttributes<object>, object>;
        thead: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        time: DetailedHTMLFactory<TimeHTMLAttributes<object>, object>;
        title: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        tr: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        track: DetailedHTMLFactory<TrackHTMLAttributes<object>, object>;
        u: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        ul: DetailedHTMLFactory<HTMLAttributes<object>, object>;
        "var": DetailedHTMLFactory<HTMLAttributes<object>, object>;
        video: DetailedHTMLFactory<VideoHTMLAttributes<object>, object>;
        wbr: DetailedHTMLFactory<HTMLAttributes<object>, object>;
    }
...
declare global {
    namespace JSX {
        ...
        interface IntrinsicElements {
            // HTML
            a: React.DetailedHTMLProps<React.AnchorHTMLAttributes<object>, object>;
            abbr: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            address: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            area: React.DetailedHTMLProps<React.AreaHTMLAttributes<object>, object>;
            article: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            aside: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            audio: React.DetailedHTMLProps<React.AudioHTMLAttributes<object>, object>;
            b: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            base: React.DetailedHTMLProps<React.BaseHTMLAttributes<object>, object>;
            bdi: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            bdo: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            big: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            blockquote: React.DetailedHTMLProps<React.BlockquoteHTMLAttributes<object>, object>;
            body: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            br: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            button: React.DetailedHTMLProps<React.ButtonHTMLAttributes<object>, object>;
            canvas: React.DetailedHTMLProps<React.CanvasHTMLAttributes<object>, object>;
            caption: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            cite: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            code: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            col: React.DetailedHTMLProps<React.ColHTMLAttributes<object>, object>;
            colgroup: React.DetailedHTMLProps<React.ColgroupHTMLAttributes<object>, object>;
            data: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            datalist: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            dd: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            del: React.DetailedHTMLProps<React.DelHTMLAttributes<object>, object>;
            details: React.DetailedHTMLProps<React.DetailsHTMLAttributes<object>, object>;
            dfn: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            dialog: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            div: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            dl: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            dt: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            em: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            embed: React.DetailedHTMLProps<React.EmbedHTMLAttributes<object>, object>;
            fieldset: React.DetailedHTMLProps<React.FieldsetHTMLAttributes<object>, object>;
            figcaption: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            figure: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            footer: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            form: React.DetailedHTMLProps<React.FormHTMLAttributes<object>, object>;
            h1: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            h2: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            h3: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            h4: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            h5: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            h6: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            head: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            header: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            hgroup: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            hr: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            html: React.DetailedHTMLProps<React.HtmlHTMLAttributes<object>, object>;
            i: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            iframe: React.DetailedHTMLProps<React.IframeHTMLAttributes<object>, object>;
            img: React.DetailedHTMLProps<React.ImgHTMLAttributes<object>, object>;
            input: React.DetailedHTMLProps<React.InputHTMLAttributes<object>, object>;
            ins: React.DetailedHTMLProps<React.InsHTMLAttributes<object>, object>;
            kbd: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            keygen: React.DetailedHTMLProps<React.KeygenHTMLAttributes<object>, object>;
            label: React.DetailedHTMLProps<React.LabelHTMLAttributes<object>, object>;
            legend: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            li: React.DetailedHTMLProps<React.LiHTMLAttributes<object>, object>;
            link: React.DetailedHTMLProps<React.LinkHTMLAttributes<object>, object>;
            main: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            map: React.DetailedHTMLProps<React.MapHTMLAttributes<object>, object>;
            mark: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            menu: React.DetailedHTMLProps<React.MenuHTMLAttributes<object>, object>;
            menuitem: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            meta: React.DetailedHTMLProps<React.MetaHTMLAttributes<object>, object>;
            meter: React.DetailedHTMLProps<React.MeterHTMLAttributes<object>, object>;
            nav: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            noindex: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            noscript: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            object: React.DetailedHTMLProps<React.ObjectHTMLAttributes<object>, object>;
            ol: React.DetailedHTMLProps<React.OlHTMLAttributes<object>, object>;
            optgroup: React.DetailedHTMLProps<React.OptgroupHTMLAttributes<object>, object>;
            option: React.DetailedHTMLProps<React.OptionHTMLAttributes<object>, object>;
            output: React.DetailedHTMLProps<React.OutputHTMLAttributes<object>, object>;
            p: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            param: React.DetailedHTMLProps<React.ParamHTMLAttributes<object>, object>;
            picture: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            pre: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            progress: React.DetailedHTMLProps<React.ProgressHTMLAttributes<object>, object>;
            q: React.DetailedHTMLProps<React.QuoteHTMLAttributes<object>, object>;
            rp: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            rt: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            ruby: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            s: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            samp: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            script: React.DetailedHTMLProps<React.ScriptHTMLAttributes<object>, object>;
            section: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            select: React.DetailedHTMLProps<React.SelectHTMLAttributes<object>, object>;
            small: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            source: React.DetailedHTMLProps<React.SourceHTMLAttributes<object>, object>;
            span: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            strong: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            style: React.DetailedHTMLProps<React.StyleHTMLAttributes<object>, object>;
            sub: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            summary: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            sup: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            table: React.DetailedHTMLProps<React.TableHTMLAttributes<object>, object>;
            tbody: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            td: React.DetailedHTMLProps<React.TdHTMLAttributes<object>, object>;
            textarea: React.DetailedHTMLProps<React.TextareaHTMLAttributes<object>, object>;
            tfoot: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            th: React.DetailedHTMLProps<React.ThHTMLAttributes<object>, object>;
            thead: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            time: React.DetailedHTMLProps<React.TimeHTMLAttributes<object>, object>;
            title: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            tr: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            track: React.DetailedHTMLProps<React.TrackHTMLAttributes<object>, object>;
            u: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            ul: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            "var": React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;
            video: React.DetailedHTMLProps<React.VideoHTMLAttributes<object>, object>;
            wbr: React.DetailedHTMLProps<React.HTMLAttributes<object>, object>;

            // SVG
            svg: React.SVGProps<object>;

            animate: React.SVGProps<object>; // TODO: It is object but is not in TypeScript's lib.dom.d.ts for now.
            animateTransform: React.SVGProps<object>; // TODO: It is object but is not in TypeScript's lib.dom.d.ts for now.
            circle: React.SVGProps<object>;
            clipPath: React.SVGProps<object>;
            defs: React.SVGProps<object>;
            desc: React.SVGProps<object>;
            ellipse: React.SVGProps<object>;
            feBlend: React.SVGProps<object>;
            feColorMatrix: React.SVGProps<object>;
            feComponentTransfer: React.SVGProps<object>;
            feComposite: React.SVGProps<object>;
            feConvolveMatrix: React.SVGProps<object>;
            feDiffuseLighting: React.SVGProps<object>;
            feDisplacementMap: React.SVGProps<object>;
            feDistantLight: React.SVGProps<object>;
            feFlood: React.SVGProps<object>;
            feFuncA: React.SVGProps<object>;
            feFuncB: React.SVGProps<object>;
            feFuncG: React.SVGProps<object>;
            feFuncR: React.SVGProps<object>;
            feGaussianBlur: React.SVGProps<object>;
            feImage: React.SVGProps<object>;
            feMerge: React.SVGProps<object>;
            feMergeNode: React.SVGProps<object>;
            feMorphology: React.SVGProps<object>;
            feOffset: React.SVGProps<object>;
            fePointLight: React.SVGProps<object>;
            feSpecularLighting: React.SVGProps<object>;
            feSpotLight: React.SVGProps<object>;
            feTile: React.SVGProps<object>;
            feTurbulence: React.SVGProps<object>;
            filter: React.SVGProps<object>;
            foreignObject: React.SVGProps<object>;
            g: React.SVGProps<object>;
            image: React.SVGProps<object>;
            line: React.SVGProps<object>;
            linearGradient: React.SVGProps<object>;
            marker: React.SVGProps<object>;
            mask: React.SVGProps<object>;
            metadata: React.SVGProps<object>;
            path: React.SVGProps<object>;
            pattern: React.SVGProps<object>;
            polygon: React.SVGProps<object>;
            polyline: React.SVGProps<object>;
            radialGradient: React.SVGProps<object>;
            rect: React.SVGProps<object>;
            stop: React.SVGProps<object>;
            switch: React.SVGProps<object>;
            symbol: React.SVGProps<object>;
            text: React.SVGProps<object>;
            textPath: React.SVGProps<object>;
            tspan: React.SVGProps<object>;
            use: React.SVGProps<object>;
            view: React.SVGProps<object>;
        }
    }
}
