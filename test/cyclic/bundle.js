...
system.register("cyclic/cyclic", ["./cyclic/main"], function(system,module) {
    var main_1;
    return {
        setters:[
            function (main_1_1) {
        ...
        execute: function() {
            console.info(main_1.default);
        }
    }
});
system.register("cyclic/test", ["./decor/decors"], function(system,module) {
    var decors_1;
    var Decorated = (function (__super) {
        Decorated.__decorator = function(__decorate,__type){
            __decorate(142,"hello",18,Object,null,[
                [decors_1.Meta,56]
            ],null);
            __decorate(142,"extended",18,Object,null,[
                [decors_1.DecorExtended,56]
            ],null);
            Decorated = 
            __decorate(217, 0, 80, 0, 0, 0, [
                [decors_1.Decor,'Hello','world']
            ],[
                ["one",0,String],
                ["two",0,Number]
            ]);
        ...
        return Decorated;
        function Decorated(one, two) {
        }
    })();
    module.define('class', Decorated);
    module.export("Decorated", Decorated);
    return {
        setters:[
            function (decors_1_1) {
                decors_1 = decors_1_1;
        ...
        execute: function() {
            Decorated = module.init(Decorated);
            module.export("default",new Decorated('A', 1));
        }
    }
});
system.register("cyclic/cyclic/four", ["runtime/decorators", "runtime/reflect/class"], function(system,module) {
    var decorators_1, class_1;
    var TOP;
    var Enum = new (function Enum(){
        this[this.VALUE_1 = 0] = "VALUE_1";
        this[this.VALUE_2 = 1] = "VALUE_2";
    })();
    module.define("enum", Enum)
    module.export("Enum", Enum);
    var Decor = (function (__super) {
        Decor.prototype.decorate = function (target) {
            console.info("TARGET", target);
        };
        Decor.__initializer = function(__parent){
            __super=__parent;
        };
        return Decor;
        function Decor() {
    ...
    module.define('class', Decor);
    var Four = (function (__super) {
        Object.defineProperty(Four, "staticAccessor", {
            get: function () {
        ...
        Four.staticFunction = function (v) {
            return this.staticVariable = v;
        };
        Object.defineProperty(Four.prototype, "memberAccessor", {
            get: function () {
        ...
        Four.prototype.memberFunction = function (v) {
            return this.memberVariable = v;
        };
        Four.prototype.toString = function () {
            return this.memberVariable;
        };
        Four.__initializer = function(__parent){
            __super=__parent;
            Four.staticVariable = 'Hello';
        };
        Four.__decorator = function(__decorate,__type){
            __decorate(142,"memberVariable",18,String,null,[
                [Decor]
            ],null);
            __decorate(146,"memberAccessor",18,String,null,[
                [Decor]
            ],null);
            __decorate(147,"memberAccessor",2,String,void 0,null,[
                ["v",0,String]
            ]);
            __decorate(144,"memberFunction",18,Function,String,[
                [Decor]
            ],[
                ["v",0,String,[
                    [Decor]
            ...
            __decorate(144,"toString",2,Function,void 0,null,null);
            __decorate(142,"staticVariable",17,String,null,[
                [Decor]
            ],null);
            __decorate(146,"staticAccessor",17,String,null,[
                [Decor]
            ],null);
            __decorate(147,"staticAccessor",1,String,void 0,null,[
                ["v",0,String]
            ]);
            __decorate(144,"staticFunction",17,Function,String,[
                [Decor]
            ],[
                ["v",0,String,[
                    [Decor]
    ...
    module.define('class', Four);
    module.export("Four", Four);
    return {
        setters:[
            function (decorators_1_1) {
                decorators_1 = decorators_1_1;
        ...
        execute: function() {
            module.export("TOP", TOP = 'Hello');
            Decor = module.init(Decor,decorators_1.Decorator);
            Four = module.init(Four);
            module.export("default",new Four('Four Default'));
        }
    }
});
system.register("cyclic/cyclic/main", ["./one", "./two"], function(system,module) {
    var one_1, two_1;
    ...
    var Main = (function (__super) {
        ...
        Main.__initializer = function(__parent){
            __super=__parent;
            Main.great = 'Main.from';
        };
        return Main;
        function Main(config) {
            __super.call(this, config);
    ...
    return {
        ...
        execute: function() {
            Base = module.init(Base);
            Main = module.init(Main,Base);
            module.export("default",new Main('Test'));
        }
    }
});
system.register("cyclic/cyclic/one", ['./main', './three'], function(system,module) {
    var main_1, three_1;
    var One = (function (__super) {
        One.prototype.toString = function () {
            return "One(" + this.value + ")";
        };
        return One;
        function One() {
            this.value = main_1.Main.from(three_1.default);
        }
    })();
    module.define('class', One);
...
system.register("cyclic/cyclic/three", ["./four"], function(system,module) {
    var four_1;
    var Three = (function (__super) {
        Three.prototype.toString = function () {
            return "Three + " + four_1.default.toString();
        };
        return Three;
        function Three() {
        }
    })();
    module.define('class', Three);
    module.export("Three", Three);
    return {
        setters:[
            function (four_1_1) {
                four_1 = four_1_1;
        ...
        execute: function() {
            Three = module.init(Three);
            module.export("default",new Three());
        }
    }
});
system.register("cyclic/cyclic/two", ['./main', './three'], function(system,module) {
    var main_1, three_1;
    var Two = (function (__super) {
...
system.register("cyclic/decor/decorated", ["./decors"], function(system,module) {
    var decors_1;
    return {
        setters:[
            function (decors_1_1) {
        ...
        execute: function() {
            module.export("Decor", decors_1.default);
        }
    }
});
system.register("cyclic/decor/decors", ["runtime/decorators"], function(system,module) {
    var decorators_1;
    function Meta(type) {
        return function (target, key, desc) {
        };
    }
    module.define('function', Meta)
    module.export("Meta", Meta);
    var Decor = (function (__super) {
        return Decor;
        function Decor(key, value) {
            this.key = key;
            this.value = value;
        }
    })();
    module.define('class', Decor);
    module.export("Decor", Decor);
    var DecorExtended = (function (__super) {
        DecorExtended.prototype.decorate = function () {
        };
        DecorExtended.__initializer = function(__parent){
            __super=__parent;
        };
        return DecorExtended;
        function DecorExtended(param) {
            __super.call(this);
        }
    })();
    module.define('class', DecorExtended);
    module.export("DecorExtended", DecorExtended);
    return {
        setters:[
            function (decorators_1_1) {
                decorators_1 = decorators_1_1;
        ...
        execute: function() {
            Decor = module.init(Decor);
            DecorExtended = module.init(DecorExtended,decorators_1.Decorator);
            module.export("default",new Decor('hello', 'world'));
        }
    }
});
